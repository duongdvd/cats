...
<c:set var="titleCode" value="devices.deviceAdd"></c:set>
<%@ include file="/resources/layout/pageHeader.jsp"%>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><spring:message code="devices.deviceAdd"/></h1>
        </section>
        <!-- Main content -->
        <section id="content" class="content">
            <p><spring:htmlEscape defaultHtmlEscape="true"/><%@ include file="/resources/layout/messageList.jsp" %></p>
            <%--<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>--%>
            <s:form method="POST" action="${ctx}/addOrEditDevice" modelAttribute="deviceForm" class="form-horizontal"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="carMaker" name="carMaker"
                                           ...
                                           value="<c:out value="${deviceForm.carMaker}"/>">
                                </div>
                            </div>
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-default" href="${deviceList}" data-toggle="tooltip"
